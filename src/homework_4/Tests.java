...
System.out.println();
    ...
    public void test_3() {
        ...
        String result = stringList.stream().map(x -> "number " + x)
    ...
    public void test_4() {
        ...
        Map filtMap = map.entrySet()
                .stream().filter(x->x.getKey() > 3 && x.getKey() < 9)
                .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
        System.out.println(filtMap);
    ...
    public void test_6() {
        ...
        elements.stream().peek(x -> x.setDisplayed(true)).
                filter(x -> x.getValue() == null).toList().
